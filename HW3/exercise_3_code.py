...
epsilon = 1 / 298.257223563
phi = np.arctan((1/(1 - epsilon)) ** 2 * np.tan(site_lat))
site_coord_1=coordinates.EarthLocation.from_geodetic(site_lon,phi,0*u.m)  # 由 测地经纬度 获得 地固系XYZ坐标，同书上(1.64)式
site_coord = site_coord_1
